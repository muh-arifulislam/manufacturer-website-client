...
const ManageProducts = () => {
  ...
  const {
    ...
    fetch(
      `https://manufacturer-website-server-production-7476.up.railway.app/tool`
    ).then(async (res) => {
  ...
  const handleDeleteProduct = () => {
    fetch(
      `https://manufacturer-website-server-production-7476.up.railway.app/tool/${selectedProductId}?email=${user.email}`,
      {
        method: "DELETE",
        headers: {
